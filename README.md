...
Weights included: Merriweather 300/400/700/900 + 400 italic, Merriweather Sans 300/400/700/800 + 400 italic. Merriweather 300 (serif light) is declared but unused — harmless to leave, safe to drop. The five sans page titles (Index, Logos 27, Discorso, Curriculum, Foto) use Sans 800; the family has no 900 cut, so don't set `font-weight: 900` on them.
